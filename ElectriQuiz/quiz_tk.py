...
def resp_callback():
    ...
    resp_text.place(relx=0.5, rely=0.5, anchor='center')
    #boton de pregunta
...
def begin_callback():
    ...
    logo2_im.thumbnail((round(65*1.23), 65))
...
def inicio():
    ...
    logo_im.thumbnail((300,300*1.1855))
